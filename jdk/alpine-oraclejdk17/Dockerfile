...
ENV JAVA_VERSION=11.0.5 \
    JAVA_BUILD=10 \
    JAVA_PATH=e51269e04165492b90fa15af5b4eb1a5 \
...
RUN apk add --no-cache --virtual=build-dependencies wget ca-certificates unzip && \
    ...
    #     "http://download.oracle.com/otn/java/jdk/${JAVA_VERSION}+${JAVA_BUILD}/${JAVA_PATH}/jdk-${JAVA_VERSION}_linux-x64_bin.tar.gz" && \
