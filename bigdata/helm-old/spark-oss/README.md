...
* Enable your spark read/write data to aliyun OSS
...
* Assumes you already has  OSS keyID and key_secret.
...
```bash
$ helm install --name my-release  --set Worker.oss_access_key_id=<your_oss_access_key_id>,Worker.oss_access_key_secret=<your_oss_key_secret>   stable/spark-oss
```

> **Tip**: You can use the default [values.yaml](values.yaml)

#### Test your OSS access

```
kubectl exec -it my-release-worker-<id> bash

/opt/spark/bin/spark-shell

scala> val lines = sc.textFile("oss://<your bucket>/testwrite")
lines: org.apache.spark.rdd.RDD[String] = oss://eric-new/testwrite MapPartitionsRDD[1] at textFile at <console>:24
