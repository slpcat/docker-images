...
sed -i "/config.show.applicationStat=/ s/=.*/=${SHOW_APPLICATIONSTAT}/" /usr/local/tomcat/webapps/ROOT/WEB-INF/classes/pinpoint-web.properties
...
#sed -i "/hbase.namespace=/ s/=.*/=${HBASE_NAMESPACE}/" /usr/local/tomcat/webapps/ROOT/WEB-INF/classes/hbase.properties
